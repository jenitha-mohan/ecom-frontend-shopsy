...
const Navbar = () => {
  return (
    <nav className="w-full h-20 flex items-center justify-between px-8 md:px-16 
      bg-white/80 backdrop-blur-md border-b border-pink-200 
      sticky top-0 z-50">

      {/* 🌸 Logo */}
      <div className="text-pink-600 text-3xl font-extrabold tracking-wide">
        StyleUp
      </div>

      {/* 🌸 Nav Links */}
      <div className="hidden md:flex gap-8 text-lg font-medium text-slate-700">
      ...
      <div className="flex gap-3">
        <Link
          to="/login"
          className="px-5 py-2 rounded-full border border-pink-500 
          text-pink-600 hover:bg-pink-50 transition"
        >
          Login
        </Link>
